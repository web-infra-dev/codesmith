...
Thanks for that you are interested in contributing to CodeSmith.
...
CodeSmith is using [Changesets](https://github.com/changesets/changesets) to manage the versioning and changelogs.
